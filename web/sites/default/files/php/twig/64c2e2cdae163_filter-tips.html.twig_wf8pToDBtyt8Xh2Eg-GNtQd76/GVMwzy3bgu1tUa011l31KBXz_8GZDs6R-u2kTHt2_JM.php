...
/* themes/nativebiodata/templates/content-edit/filter-tips.html.twig */
class __TwigTemplate_96b260200ac8128e32671b28e5465fdf extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return "themes/nativebiodata/templates/content-edit/filter-tips.html.twig";
    }
    ...
    {
        return new Source("", "themes/nativebiodata/templates/content-edit/filter-tips.html.twig", "C:\\xampp4\\htdocs\\nbd\\web\\themes\\nativebiodata\\templates\\content-edit\\filter-tips.html.twig");
    }
